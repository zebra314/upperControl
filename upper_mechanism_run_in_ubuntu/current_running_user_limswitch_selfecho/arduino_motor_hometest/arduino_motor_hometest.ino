...
//test servo and test limswitch
Servo ser;
int ser_status;
boolean ser_arrive = 0;
int ser_stage = 0;
...
/* Programs about the motion of the test servo */
void servo_stop()
{
    ser.write(90);
}
...
void servo_backward(int& status)
{
    if (digitalRead(12) == 1)
    {
        // backward
